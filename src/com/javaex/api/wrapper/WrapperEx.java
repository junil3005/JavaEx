...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		//	new wapper는 jdk9 부터 deprecated -> 가급적 빨리 수정 권장
		...
		//	주의: 문자열의 형태가 해당 자료의 형태를 갖춰야 한다.
		
		//	parse 계열 메서드 : 문자열을 이용, 해당 타입으로 변환,
		//						출력 형태 변환하는 경우
		System.out.println(Integer.parseInt("-123"));	// 문자열 -> 정수
		System.out.print(Integer.parseInt("10", 16));	// 16진수 문자열 -> 10진수
		System.out.println(
				Integer.toBinaryString(28));			// 2진수 형태 문자열로 변환
		System.out.println(
				Integer.toHexString(28));				//	16진수 형태 문자열로 변환
		...
		//	자동 박싱(Auto Boxing)
		Integer i3 = 10;	//	=. Integer i3 = Integer.vlaueOf(10);
